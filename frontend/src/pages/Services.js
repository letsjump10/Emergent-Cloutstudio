      ...
      <main className="pt-24 pb-16">
            ...
            <div className="space-y-8">
              {servicesData.map((service, index) => (
                <motion.div
                  ...
                  className="glass-panel hover:border-neon-cyan/50 transition-all duration-300"
                    ...
                    <div className="grid md:grid-cols-[1fr_auto] gap-8 items-start">
                      <div>
                        <div className="flex items-center gap-4 mb-4">
                          <div className="w-12 h-12 flex items-center justify-center glass-panel border-neon-cyan/30">
                            <span className="text-neon-cyan text-xl font-bold">{(index + 1).toString().padStart(2, '0')}</span>
                          </div>
                          <h2 className="text-2xl sm:text-3xl font-syne font-bold group-hover:text-neon-cyan transition-colors">
                            {service.name}
                          </h2>
                        </div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                          <div>
                            <h3 className="text-sm font-semibold text-neon-cyan mb-3 uppercase tracking-wider">Who it's for:</h3>
                          ...
                          <div>
                            <h3 className="text-sm font-semibold text-neon-cyan mb-3 uppercase tracking-wider">Key deliverables:</h3>
                            <ul className="space-y-2">
                      ...
                      <div className="flex flex-col items-end gap-4">
                        <div className="text-right">
                          ...
                          <div className="font-semibold text-neon-cyan">{service.timeline}</div>
                        </div>
        ...
        <section className="py-16 bg-gradient-to-r from-neon-cyan/10 via-purple-500/10 to-neon-cyan/10 border-y border-white/5">
          <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
            ...
            <p className="text-white/70 mb-8">Book a free consultation and we'll recommend the best approach for your business.</p>
